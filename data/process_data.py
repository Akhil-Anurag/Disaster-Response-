...
def load_data(messages_filepath, categories_filepath):
    ...
    This code will read these two files and load them into dataframes
    '''
...
def clean_data(df):
    '''
    This part takes the dataframe and return a cleaned data frame
    '''
...
def save_data(df, database_filename):
    '''
    This function takes the cleaned dataframe as input 
    and returns a sqllite db named database_filename: database name, e.g. DisasterMessages.db
    and table name as DisasterMessages
    '''
